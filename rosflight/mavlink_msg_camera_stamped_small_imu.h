...
#define MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_MIN_LEN 37
#define MAVLINK_MSG_ID_185_LEN 37
#define MAVLINK_MSG_ID_185_MIN_LEN 37
                               ...
                               uint64_t time_boot_us, float xacc, float yacc, float zacc, float xgyro, float ygyro, float zgyro, float temperature, uint8_t image)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_MIN_LEN, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_LEN, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_CRC);
}
                                   ...
                                   uint64_t time_boot_us,float xacc,float yacc,float zacc,float xgyro,float ygyro,float zgyro,float temperature,uint8_t image)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_MIN_LEN, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_LEN, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_CRC);
}
...
static inline void mavlink_msg_camera_stamped_small_imu_send(mavlink_channel_t chan, uint64_t time_boot_us, float xacc, float yacc, float zacc, float xgyro, float ygyro, float zgyro, float temperature, uint8_t image)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU, buf, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_MIN_LEN, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_LEN, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_CRC);
#else
    mavlink_camera_stamped_small_imu_t packet;
    packet.time_boot_us = time_boot_us;
    packet.xacc = xacc;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU, (const char *)&packet, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_MIN_LEN, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_LEN, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_camera_stamped_small_imu_send_struct(mavlink_channel_t chan, const mavlink_camera_stamped_small_imu_t* camera_stamped_small_imu)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_camera_stamped_small_imu_send(chan, camera_stamped_small_imu->time_boot_us, camera_stamped_small_imu->xacc, camera_stamped_small_imu->yacc, camera_stamped_small_imu->zacc, camera_stamped_small_imu->xgyro, camera_stamped_small_imu->ygyro, camera_stamped_small_imu->zgyro, camera_stamped_small_imu->temperature, camera_stamped_small_imu->image);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU, (const char *)camera_stamped_small_imu, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_MIN_LEN, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_LEN, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_LEN? msg->len : MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_LEN;
        memset(camera_stamped_small_imu, 0, MAVLINK_MSG_ID_CAMERA_STAMPED_SMALL_IMU_LEN);
    memcpy(camera_stamped_small_imu, _MAV_PAYLOAD(msg), len);
#endif
}
