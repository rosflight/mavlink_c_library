...
#define MAVLINK_MSG_ID_ROSFLIGHT_GPS_MIN_LEN 49
#define MAVLINK_MSG_ID_197_LEN 49
#define MAVLINK_MSG_ID_197_MIN_LEN 49
                               ...
                               double latitude, double longitude, float altitude, float velN, float velE, float velD, uint8_t fix_type, uint32_t tow_ms, float hacc, float vacc, float sacc)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ROSFLIGHT_GPS_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_CRC);
}
                                   ...
                                   double latitude,double longitude,float altitude,float velN,float velE,float velD,uint8_t fix_type,uint32_t tow_ms,float hacc,float vacc,float sacc)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_ROSFLIGHT_GPS;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ROSFLIGHT_GPS_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_CRC);
}
...
static inline void mavlink_msg_rosflight_gps_send(mavlink_channel_t chan, double latitude, double longitude, float altitude, float velN, float velE, float velD, uint8_t fix_type, uint32_t tow_ms, float hacc, float vacc, float sacc)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_GPS, buf, MAVLINK_MSG_ID_ROSFLIGHT_GPS_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_CRC);
#else
    mavlink_rosflight_gps_t packet;
    packet.latitude = latitude;
    packet.longitude = longitude;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_GPS, (const char *)&packet, MAVLINK_MSG_ID_ROSFLIGHT_GPS_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_rosflight_gps_send_struct(mavlink_channel_t chan, const mavlink_rosflight_gps_t* rosflight_gps)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_rosflight_gps_send(chan, rosflight_gps->latitude, rosflight_gps->longitude, rosflight_gps->altitude, rosflight_gps->velN, rosflight_gps->velE, rosflight_gps->velD, rosflight_gps->fix_type, rosflight_gps->tow_ms, rosflight_gps->hacc, rosflight_gps->vacc, rosflight_gps->sacc);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_GPS, (const char *)rosflight_gps, MAVLINK_MSG_ID_ROSFLIGHT_GPS_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_ROSFLIGHT_GPS_LEN? msg->len : MAVLINK_MSG_ID_ROSFLIGHT_GPS_LEN;
        memset(rosflight_gps, 0, MAVLINK_MSG_ID_ROSFLIGHT_GPS_LEN);
    memcpy(rosflight_gps, _MAV_PAYLOAD(msg), len);
#endif
}
