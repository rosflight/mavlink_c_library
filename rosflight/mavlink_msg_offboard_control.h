...
#define MAVLINK_MSG_ID_OFFBOARD_CONTROL_MIN_LEN 18
...
{
    return mavlink_msg_offboard_control_pack_status(system_id, component_id, _status, msg,  offboard_control->mode, offboard_control->ignore, offboard_control->x, offboard_control->y, offboard_control->z, offboard_control->F);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_offboard_control_send(chan, offboard_control->mode, offboard_control->ignore, offboard_control->x, offboard_control->y, offboard_control->z, offboard_control->F);
#else
