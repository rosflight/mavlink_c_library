...
#define MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN 1
#define MAVLINK_MSG_ID_189_LEN 1

#define MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_CRC 67
#define MAVLINK_MSG_ID_189_CRC 67
...
{
	return mavlink_msg_rosflight_cmd_ack_pack(system_id, component_id, msg, rosflight_cmd_ack->command);
}
...
{
	return mavlink_msg_rosflight_cmd_ack_pack_chan(system_id, component_id, chan, msg, rosflight_cmd_ack->command);
}
...
static inline void mavlink_msg_rosflight_cmd_ack_send(mavlink_channel_t chan, uint8_t command)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN];
	_mav_put_uint8_t(buf, 0, command);
 ...
 */
static inline void mavlink_msg_rosflight_cmd_ack_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t command)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
