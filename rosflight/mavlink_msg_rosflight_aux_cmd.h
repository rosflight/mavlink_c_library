...
typedef struct __mavlink_rosflight_aux_cmd_t
{
 ...
 uint8_t type_array[8]; /*< */
} mavlink_rosflight_aux_cmd_t;

#define MAVLINK_MSG_ID_ROSFLIGHT_AUX_CMD_LEN 40
#define MAVLINK_MSG_ID_193_LEN 40

#define MAVLINK_MSG_ID_ROSFLIGHT_AUX_CMD_CRC 137
#define MAVLINK_MSG_ID_193_CRC 137

#define MAVLINK_MSG_ROSFLIGHT_AUX_CMD_FIELD_AUX_CMD_ARRAY_LEN 8
#define MAVLINK_MSG_ROSFLIGHT_AUX_CMD_FIELD_TYPE_ARRAY_LEN 8
...
#define MAVLINK_MESSAGE_INFO_ROSFLIGHT_AUX_CMD { \
	...
	{  { "aux_cmd_array", NULL, MAVLINK_TYPE_FLOAT, 8, 0, offsetof(mavlink_rosflight_aux_cmd_t, aux_cmd_array) }, \
         { "type_array", NULL, MAVLINK_TYPE_UINT8_T, 8, 32, offsetof(mavlink_rosflight_aux_cmd_t, type_array) }, \
         } \
}
						       ...
						       const uint8_t *type_array, const float *aux_cmd_array)
{
	...
	_mav_put_uint8_t_array(buf, 32, type_array, 8);
	...
	mav_array_memcpy(packet.type_array, type_array, sizeof(uint8_t)*8);
...
{
	return _MAV_RETURN_uint8_t_array(msg, type_array, 8,  32);
}
