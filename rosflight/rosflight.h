...
{
	ROSFLIGHT_ERROR_CODE_NONE=0, /*  | */
	ROSFLIGHT_ERROR_CODE_HOT_RESTART=1, /*  | */
	ROSFLIGHT_ERROR_CODE_INVALID_MIXER=2, /*  | */
	ROSFLIGHT_ERROR_CODE_ENUM_END=3, /*  | */
