...
#define MAVLINK_MSG_ID_SMALL_IMU_LEN 12
#define MAVLINK_MSG_ID_181_LEN 12

#define MAVLINK_MSG_ID_SMALL_IMU_CRC 82
...
#define MAVLINK_MESSAGE_INFO_SMALL_IMU { \
	"SMALL_IMU", \
	6, \
	{  { "xacc", NULL, MAVLINK_TYPE_INT16_T, 0, 0, offsetof(mavlink_small_imu_t, xacc) }, \
         { "yacc", NULL, MAVLINK_TYPE_INT16_T, 0, 2, offsetof(mavlink_small_imu_t, yacc) }, \
         { "zacc", NULL, MAVLINK_TYPE_INT16_T, 0, 4, offsetof(mavlink_small_imu_t, zacc) }, \
         { "xgyro", NULL, MAVLINK_TYPE_INT16_T, 0, 6, offsetof(mavlink_small_imu_t, xgyro) }, \
         { "ygyro", NULL, MAVLINK_TYPE_INT16_T, 0, 8, offsetof(mavlink_small_imu_t, ygyro) }, \
         { "zgyro", NULL, MAVLINK_TYPE_INT16_T, 0, 10, offsetof(mavlink_small_imu_t, zgyro) }, \
         } \
}
...
static inline uint16_t mavlink_msg_small_imu_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_SMALL_IMU_LEN];
	_mav_put_int16_t(buf, 0, xacc);
	_mav_put_int16_t(buf, 2, yacc);
	_mav_put_int16_t(buf, 4, zacc);
	_mav_put_int16_t(buf, 6, xgyro);
	_mav_put_int16_t(buf, 8, ygyro);
	_mav_put_int16_t(buf, 10, zgyro);
...
{
	return mavlink_msg_small_imu_pack(system_id, component_id, msg, small_imu->xacc, small_imu->yacc, small_imu->zacc, small_imu->xgyro, small_imu->ygyro, small_imu->zgyro);
}
...
{
	return mavlink_msg_small_imu_pack_chan(system_id, component_id, chan, msg, small_imu->xacc, small_imu->yacc, small_imu->zacc, small_imu->xgyro, small_imu->ygyro, small_imu->zgyro);
}
...
static inline void mavlink_msg_small_imu_send(mavlink_channel_t chan, int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_SMALL_IMU_LEN];
	_mav_put_int16_t(buf, 0, xacc);
 ...
 */
static inline void mavlink_msg_small_imu_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
