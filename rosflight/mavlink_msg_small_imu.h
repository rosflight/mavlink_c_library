...
#define MAVLINK_MSG_ID_SMALL_IMU_LEN 32
#define MAVLINK_MSG_ID_181_LEN 32

#define MAVLINK_MSG_ID_SMALL_IMU_CRC 199
#define MAVLINK_MSG_ID_181_CRC 199
...
#define MAVLINK_MESSAGE_INFO_SMALL_IMU { \
	"SMALL_IMU", \
	8, \
	{  { "time_boot_us", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_small_imu_t, time_boot_us) }, \
         { "xacc", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_small_imu_t, xacc) }, \
         { "yacc", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_small_imu_t, yacc) }, \
         { "zacc", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_small_imu_t, zacc) }, \
         { "xgyro", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_small_imu_t, xgyro) }, \
         { "ygyro", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_small_imu_t, ygyro) }, \
         { "zgyro", NULL, MAVLINK_TYPE_FLOAT, 0, 24, offsetof(mavlink_small_imu_t, zgyro) }, \
         { "temperature", NULL, MAVLINK_TYPE_FLOAT, 0, 28, offsetof(mavlink_small_imu_t, temperature) }, \
         } \
}
...
static inline uint16_t mavlink_msg_small_imu_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint32_t time_boot_us, float xacc, float yacc, float zacc, float xgyro, float ygyro, float zgyro, float temperature)
{
...
static inline void mavlink_msg_small_imu_send(mavlink_channel_t chan, uint32_t time_boot_us, float xacc, float yacc, float zacc, float xgyro, float ygyro, float zgyro, float temperature)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_SMALL_IMU_LEN];
	_mav_put_uint32_t(buf, 0, time_boot_us);
 ...
 */
static inline void mavlink_msg_small_imu_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_us, float xacc, float yacc, float zacc, float xgyro, float ygyro, float zgyro, float temperature)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint32_t mavlink_msg_small_imu_get_time_boot_us(const mavlink_message_t* msg)
{
