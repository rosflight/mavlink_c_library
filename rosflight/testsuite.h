...
static void mavlink_test_rosflight_hard_error(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_rosflight_hard_error_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rosflight_hard_error_pack(system_id, component_id, &msg , packet1.r0 , packet1.r1 , packet1.r2 , packet1.r3 , packet1.r12 , packet1.lr , packet1.pc , packet1.psr , packet1.reset_count , packet1.doRearm );
	mavlink_msg_rosflight_hard_error_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rosflight_hard_error_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.r0 , packet1.r1 , packet1.r2 , packet1.r3 , packet1.r12 , packet1.lr , packet1.pc , packet1.psr , packet1.reset_count , packet1.doRearm );
	mavlink_msg_rosflight_hard_error_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_rosflight_hard_error_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rosflight_hard_error_send(MAVLINK_COMM_1 , packet1.r0 , packet1.r1 , packet1.r2 , packet1.r3 , packet1.r12 , packet1.lr , packet1.pc , packet1.psr , packet1.reset_count , packet1.doRearm );
	mavlink_msg_rosflight_hard_error_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
