...
static void mavlink_test_offboard_control_full(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_OFFBOARD_CONTROL_FULL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        ...
        uint16_t i;
    mavlink_offboard_control_full_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,77,144
    };
    mavlink_offboard_control_full_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           ...
           memset(MAVLINK_MSG_ID_OFFBOARD_CONTROL_FULL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_OFFBOARD_CONTROL_FULL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_offboard_control_full_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_offboard_control_full_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_offboard_control_full_pack(system_id, component_id, &msg , packet1.mode , packet1.ignore , packet1.Qx , packet1.Qy , packet1.Qz , packet1.Fx , packet1.Fy , packet1.Fz );
    mavlink_msg_offboard_control_full_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_offboard_control_full_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.mode , packet1.ignore , packet1.Qx , packet1.Qy , packet1.Qz , packet1.Fx , packet1.Fy , packet1.Fz );
    mavlink_msg_offboard_control_full_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_offboard_control_full_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_offboard_control_full_send(MAVLINK_COMM_1 , packet1.mode , packet1.ignore , packet1.Qx , packet1.Qy , packet1.Qz , packet1.Fx , packet1.Fy , packet1.Fz );
    mavlink_msg_offboard_control_full_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("OFFBOARD_CONTROL_FULL") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_OFFBOARD_CONTROL_FULL) != NULL);
#endif
}
...
{
    mavlink_test_offboard_control_full(system_id, component_id, last_msg);
