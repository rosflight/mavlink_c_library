...
#define MAVLINK_MSG_ID_ATTITUDE_CORRECTION_MIN_LEN 16
                               ...
                               float qw, float qx, float qy, float qz)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_MIN_LEN, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_LEN, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_CRC);
}
                                   ...
                                   float qw,float qx,float qy,float qz)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_ATTITUDE_CORRECTION;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_MIN_LEN, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_LEN, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_CRC);
}
...
static inline void mavlink_msg_attitude_correction_send(mavlink_channel_t chan, float qw, float qx, float qy, float qz)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_CORRECTION, buf, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_MIN_LEN, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_LEN, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_CRC);
#else
    mavlink_attitude_correction_t packet;
    packet.qw = qw;
    packet.qx = qx;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_CORRECTION, (const char *)&packet, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_MIN_LEN, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_LEN, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_attitude_correction_send_struct(mavlink_channel_t chan, const mavlink_attitude_correction_t* attitude_correction)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_attitude_correction_send(chan, attitude_correction->qw, attitude_correction->qx, attitude_correction->qy, attitude_correction->qz);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_CORRECTION, (const char *)attitude_correction, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_MIN_LEN, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_LEN, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_ATTITUDE_CORRECTION_LEN? msg->len : MAVLINK_MSG_ID_ATTITUDE_CORRECTION_LEN;
        memset(attitude_correction, 0, MAVLINK_MSG_ID_ATTITUDE_CORRECTION_LEN);
    memcpy(attitude_correction, _MAV_PAYLOAD(msg), len);
#endif
}
