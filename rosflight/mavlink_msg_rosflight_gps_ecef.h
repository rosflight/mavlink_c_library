...
#define MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_MIN_LEN 24
                               ...
                               float pos_ecef_x, float pos_ecef_y, float pos_ecef_z, float vel_ecef_x, float vel_ecef_y, float vel_ecef_z)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_CRC);
}
                                   ...
                                   float pos_ecef_x,float pos_ecef_y,float pos_ecef_z,float vel_ecef_x,float vel_ecef_y,float vel_ecef_z)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_CRC);
}
...
static inline void mavlink_msg_rosflight_gps_ecef_send(mavlink_channel_t chan, float pos_ecef_x, float pos_ecef_y, float pos_ecef_z, float vel_ecef_x, float vel_ecef_y, float vel_ecef_z)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF, buf, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_CRC);
#else
    mavlink_rosflight_gps_ecef_t packet;
    packet.pos_ecef_x = pos_ecef_x;
    packet.pos_ecef_y = pos_ecef_y;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF, (const char *)&packet, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_rosflight_gps_ecef_send_struct(mavlink_channel_t chan, const mavlink_rosflight_gps_ecef_t* rosflight_gps_ecef)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_rosflight_gps_ecef_send(chan, rosflight_gps_ecef->pos_ecef_x, rosflight_gps_ecef->pos_ecef_y, rosflight_gps_ecef->pos_ecef_z, rosflight_gps_ecef->vel_ecef_x, rosflight_gps_ecef->vel_ecef_y, rosflight_gps_ecef->vel_ecef_z);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF, (const char *)rosflight_gps_ecef, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_LEN, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_LEN? msg->len : MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_LEN;
        memset(rosflight_gps_ecef, 0, MAVLINK_MSG_ID_ROSFLIGHT_GPS_ECEF_LEN);
    memcpy(rosflight_gps_ecef, _MAV_PAYLOAD(msg), len);
#endif
}
