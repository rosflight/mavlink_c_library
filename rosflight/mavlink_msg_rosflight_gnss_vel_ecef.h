...
#define MAVLINK_MSG_ID_ROSFLIGHT_GNSS_VEL_ECEF 200
...
{
	return mavlink_msg_rosflight_gnss_vel_ecef_pack(system_id, component_id, msg, rosflight_gnss_vel_ecef->time_of_week, rosflight_gnss_vel_ecef->ecef_v_x, rosflight_gnss_vel_ecef->ecef_v_y, rosflight_gnss_vel_ecef->ecef_v_z, rosflight_gnss_vel_ecef->s_acc);
}
...
{
	return mavlink_msg_rosflight_gnss_vel_ecef_pack_chan(system_id, component_id, chan, msg, rosflight_gnss_vel_ecef->time_of_week, rosflight_gnss_vel_ecef->ecef_v_x, rosflight_gnss_vel_ecef->ecef_v_y, rosflight_gnss_vel_ecef->ecef_v_z, rosflight_gnss_vel_ecef->s_acc);
}
...
/**
 * @brief Get field s_acc from rosflight_gnss_vel_ecef message
 *
 * @return 
 */
